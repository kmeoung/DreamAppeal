...
public class ActivityKeywordDreamInfo extends BaseActivity {
    ...
    TextView mTvTextBtn;
    @BindView(R.id.et_my_dream_keyword)
    EditText mEtMyDreamKeyword;
    @BindView(R.id.et_dream_detail_1)
    EditText mEtDreamDetail1;
    @BindView(R.id.et_dream_detail_2)
    EditText mEtDreamDetail2;
    @BindView(R.id.et_dream_detail_3)
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyword_dream_info);
